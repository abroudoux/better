...
const buttonVariants = tv({
	...
	variants: {
		variant: {
			...
			habit: "bg-muted-foreground/5 hover:bg-muted-foreground/10",
			delete: "bg-red-500/25 hover:bg-red-500/30 border-red-500",
			completed: "bg-green-500/25 hover:bg-green-500/30 border-green-500"
		},
		size: {
